        ...
        <div class='experiences'>
          <div class='row items-holder'>
            ...
            <div class='column'>
              <div class='item' v-tilt>
                <div class='img'></div>
                <div class='description'>Вас ждет много активных игр  таких как воллейбол, футбол, теннис, бейсбол,
                  тетербол. Каждый сможет найти себе игру в которой он сможет пережит незабываемые эмоции и командный дух
                </div>
                <div class='label'>Активные игры</div>
              </div>
            </div>
          </div>
